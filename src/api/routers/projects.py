...
from src.api.dependencies import get_document_repo, get_issue_repo, get_project_repo
from src.api.middleware.auth import require_scope
from src.api.schemas.common import ApiResponse, PaginatedMeta
...
from src.shared.types import ProjectId, Scope, SourceType
