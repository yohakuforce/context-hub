...
from src.domain.access_control.repository import ConsumerRepository, PermissionRepository
from src.infrastructure.db.models import ConsumerRow, PermissionRow
